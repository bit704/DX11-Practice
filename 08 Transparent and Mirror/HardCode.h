...
public:
    ...
    static void CreateVertexs(VertexPosNormalTex** vertices, UINT m_VertexCount)
    {
        *vertices = new VertexPosNormalTex[m_VertexCount]
        {
            { XMFLOAT3(-8.f,  -3.f,  4.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(0.f, 1.f) },
            { XMFLOAT3(8.f,   -3.f,  4.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(0.f, 0.f) },
            { XMFLOAT3(-8.f,  -3.f,  0.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(1.f, 1.f) },
            { XMFLOAT3(8.f,   -3.f,  0.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(1.f, 0.f) },
        };
    }
...
public:
    ...
    static void CreateVertexs(VertexPosNormalTex** vertices,UINT m_VertexCount)
    {
        *vertices = new VertexPosNormalTex[m_VertexCount]
        {
			{ XMFLOAT3(1.f,  -1.f,  1.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(0.f, 1.f) },
			{ XMFLOAT3(1.f,   1.f,  1.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(0.f, 0.f) },
			{ XMFLOAT3(1.f,  -1.f, -1.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(1.f, 1.f) },
			{ XMFLOAT3(1.f,   1.f, -1.f),  XMFLOAT3(-1.f,0.f,0.f), XMFLOAT2(1.f, 0.f) },
        };
    }
...
public:
    ...
    static void CreateVertexs(VertexPosNormalColor** vertices, UINT m_VertexCount)
    {
